...
class BottomNavBar @JvmOverloads constructor(
    ...
    init {
        //首页
        val homeItem = BottomNavigationItem(R.drawable.btn_nav_home_press, resources.getString(R.string.nav_bar_home))  // 文案 和 选中状态下图片
                .setInactiveIconResource(R.drawable.btn_nav_home_normal) // 未选中状态下图标
                .setActiveColorResource(R.color.common_blue) // 选择时 字体颜色
                .setInActiveColorResource(R.color.text_normal) // 未选择时字体颜色
